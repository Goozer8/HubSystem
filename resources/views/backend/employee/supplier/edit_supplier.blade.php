                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="type" class="form-select @error('experience') is-invalid" @enderror
                                             id="example-select">
                                                <option selected disabled="">Select Year</option>
                                                <option value="Distributor" {{ $supplier->type == '1 Year' ? 'selected' : '' }}>Distributor</option>
                                                <option value="Whole Seller" {{ $supplier->type == '1 Year' ? 'selected' : '' }}>Whole Seller</option>
                                            </select>
                                            @error('experience')
                                                <span class="text-danger"> {{ $message }} </span>
                                                @enderror
